...
/**
 * Created by duongnn on 3/18/18.
 */
public class GraphEdgePredicate extends Predicate {
    ...
    public GraphEdgePredicate(String firstNode, String secondNode, String monitorIpAddr, String monitorPortNum){
        ...
        varList0.put("flag" + firstNode + "_" + secondNode + "_" + firstNode, "1");
        varList0.put("turn" + firstNode + "_" + secondNode, firstNode);
        ...
        varList1.put("flag" + firstNode + "_" + secondNode + "_" + secondNode, "1");
        varList1.put("turn" + firstNode + "_" + secondNode, secondNode);
    ...
    public GraphEdgePredicate(String edgeStr, String monitorIpAddr, String monitorPortNum){
