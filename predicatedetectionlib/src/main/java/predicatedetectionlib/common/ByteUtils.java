 ...
 *
 * Duong: Since this class is available in Voldemort already, we do not need
 * to make it public
 */
public class ByteUtils {
    ...
    public static boolean skipByteArray(ByteBuffer buffer, int dataSize) throws Exception {
        if(dataSize < 0) {
            throw new Exception("Invalid Size for byte Array " + dataSize);
        }
