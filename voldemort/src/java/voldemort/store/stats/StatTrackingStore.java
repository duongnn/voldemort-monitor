...
public class StatTrackingStore extends DelegatingStore<ByteArray, byte[], byte[]> {
    ...
    // Duong note: this constructor is used by Voldemort client
    ...
    // Duong note: this constructor is used by server, and REST client
    ...
    public void put(ByteArray key, Versioned<byte[]> value, byte[] transforms)
        ...
        try {
            ...
            // Duong debug
            // I add this catch blog to not record PUT if not sufficient operational node
            ...
            // Duong debug
            // we record only in case not having insufficient operational node exception
