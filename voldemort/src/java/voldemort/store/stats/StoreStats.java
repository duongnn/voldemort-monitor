...
public class StoreStats {
    ...
    public void recordPutTimeAndSize(long timeNS, long valueSize, long keySize) {
        ...
        // Duong debug
//        System.out.println("\n recordPutTime: " + timeNS + " valueSize: " + valueSize + " keySize: " + keySize);
//        Thread.dumpStack();
//        System.out.println("\n Throughput: put = " + getThroughput(Tracked.PUT) + " get = " + getThroughput(Tracked.GET));
//        System.out.println();

        // Duong: record performance
        DebugPerformance.voldemort.recordPerformance(System.currentTimeMillis(),
                                                 getThroughput(Tracked.PUT),
                                                 getAvgTimeInMs(Tracked.PUT),
                                                 getThroughput(Tracked.GET),
                                                 getAvgTimeInMs(Tracked.GET));
