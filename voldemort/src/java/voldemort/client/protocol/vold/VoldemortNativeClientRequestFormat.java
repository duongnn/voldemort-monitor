...
public class VoldemortNativeClientRequestFormat implements RequestFormat {
    ...
    public void writeDeleteRequest(DataOutputStream outputStream,
        ...
        PredicateDetection.HvcProcessing.writeClientHvcTimestamp(outputStream);
    ...
    public boolean readDeleteResponse(DataInputStream inputStream) throws IOException {
        ...
        PredicateDetection.HvcProcessing.updateClientHvcFromStream(inputStream);
    ...
    public boolean isCompleteGetResponse(ByteBuffer buffer) {
        try {
            ...
            PredicateDetection.HvcProcessing.readHvcFromStream(inputStream);
    ...
    public void writeGetAllRequest(DataOutputStream output,
        ...
        PredicateDetection.HvcProcessing.writeClientHvcTimestamp(output);
    ...
    public Map<ByteArray, List<Versioned<byte[]>>> readGetAllResponse(DataInputStream stream)
        ...
        PredicateDetection.HvcProcessing.updateClientHvcFromStream(stream);
    ...
    public int getExpectedPutRequestSize(String storeName,
        ...
        // space for HVC
        size += PredicateDetection.HvcProcessing.getHvcTimestampSizeInBytes();
